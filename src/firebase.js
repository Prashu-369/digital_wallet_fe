...
import {
  ...
  ref,
  update,
  get,        // ✅ added: for reading once
  push,       // ✅ added: for adding new items (e.g., transactions)
  onValue     // ✅ added: for real-time listeners
} from "firebase/database"; // Firebase Realtime Database imports
...
export { auth, db, ref, update, get, push, onValue }; // ✅ added: get, push, onValue
